...
training_setups = [
    ...
    r'./venv/Scripts/python train.py --model="UnetPlusPlus" --encoder="efficientnet-b7" --epochs=200 --batch-size=80 --patch-size=256 --weight-decay=1e-4 --save-checkpoints --use-amp',
